...
UpdatePacket::UpdatePacket(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->cost = 0;
}

UpdatePacket::UpdatePacket(const UpdatePacket& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
const char * UpdatePacket::getSource() const
{
    return this->source.c_str();
}

void UpdatePacket::setSource(const char * source)
{
    this->source = source;
}

const char * UpdatePacket::getDestination() const
{
    return this->destination.c_str();
}

void UpdatePacket::setDestination(const char * destination)
{
    this->destination = destination;
}

double UpdatePacket::getCost() const
{
    return this->cost;
}

void UpdatePacket::setCost(double cost)
{
    this->cost = cost;
}
...
UpdatePacketDescriptor::UpdatePacketDescriptor() : omnetpp::cClassDescriptor("UpdatePacket", "omnetpp::cPacket")
{
...
int UpdatePacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    UpdatePacket *pp = (UpdatePacket *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *UpdatePacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string UpdatePacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool UpdatePacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *UpdatePacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
