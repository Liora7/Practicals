  ...
  match t with
    ...
    | <BINOP Times, t1, t2> ->
        ...
        (match t2 with
            <CONST 3> ->
              let v1 = e_reg t1 anyreg in
                reserve_reg (reg_of v1); gen_reg "add" [r; v1; Shift ((reg_of v1), 1)]
          | <CONST 9> ->
              let v1 = e_reg t1 anyreg in
                reserve_reg (reg_of v1); gen_reg "add" [r; v1; Shift ((reg_of v1), 3)]
          | <CONST 10> ->
              let v1 = e_reg t1 anyreg in
              let v2 = e_reg t2 anyreg in
                reserve_reg (reg_of v1);
                gen_reg "add" [v1; v1; Shift ((reg_of v1), 2)];
                gen_reg "add" [r; v1; Shift ((reg_of v2), 1)]
          | _ ->
              let v1 = e_reg t1 anyreg in
              let v2 = e_reg t2 anyreg in
                gen_reg "mul" [r; v1; v2])
